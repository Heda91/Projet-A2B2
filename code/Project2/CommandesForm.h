...
namespace Display {
	...
	/// </summary>
	public ref class CommandesForm : public System::Windows::Forms::Form
	{
	public:
		CommandesForm(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button3->Click += gcnew System::EventHandler(this, &CommandesForm::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &CommandesForm::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &CommandesForm::button1_Click);
			// 
			// dataGridView1
			// 
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	ModifCommandForm ModifCommandF;
	ModifCommandF.ShowDialog();
}
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	ModifCommandForm AddCommandF;
	AddCommandF.ShowDialog();
}
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	ViewCommandForm ViewCommandF;
