...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Click += gcnew System::EventHandler(this, &ModifClientForm::label1_Click);
			// 
			// label2
			// 
			...
			this->ClientSize = System::Drawing::Size(527, 350);
			...
			this->Load += gcnew System::EventHandler(this, &ModifClientForm::ModifClient_Load);
