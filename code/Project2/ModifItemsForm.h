...
namespace Display {
	...
	/// </summary>
	public ref class ModifItemsForm : public System::Windows::Forms::Form
	{
	public:
		ModifItemsForm(ArticleObject^ ao)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(ArticleObject^ ao)
		{
			...
			this->button_valid->Click += gcnew System::EventHandler(this, &Display::ModifItemsForm::buttonValidClick);
			...
			this->Name = L"ModifItemsForm";
			this->Text = L"ViewArticle";
			this->Load += gcnew System::EventHandler(this, &ModifItemsForm::ViewArticleLoad);
