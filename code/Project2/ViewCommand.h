...
namespace Project2 {
	...
	/// </summary>
	public ref class ViewCommand : public System::Windows::Forms::Form
	{
	public:
		ViewCommand(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Click += gcnew System::EventHandler(this, &ViewCommand::label1_Click);
			// 
			// textBox6
			// 
